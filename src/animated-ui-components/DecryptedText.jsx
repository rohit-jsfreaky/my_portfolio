...
return (
  <motion.span
    ref={containerRef}
    className={`inline-block whitespace-pre-wrap relative font-['Merriweather'] ${parentClassName}`}
    {...hoverProps}
    {...props}
  >
    <span className="sr-only font-['Merriweather']">{displayText}</span>

    <span aria-hidden="true" className="font-['Merriweather']">
